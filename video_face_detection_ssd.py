...
webcam_video_stream = cv2.VideoCapture(0) #'/Users/dc/Desktop/portfoliocCodes/Face/lib/LiveFace.mp4')
...
face_detection_classifier = cv2.dnn.readNetFromCaffe('/Users/dc/Desktop/portfoliocCodes/Face/lib/models/deploy'
                                                     '.prototxt.txt',
                                                     '/Users/dc/Desktop/portfoliocCodes/Face/lib/models'
...
while True:
    ...
    for index in range(no_of_detections):
        ...
        if detection_confidence > 0.5:
            current_face_location = all_face_locations[0, 0, index, 3:7] * np.array(
            ...
            print(
                'Found face {} at left_x:{},left_y:{},right_x:{},right_y:{}'.format(index + 1, left_x, left_y, right_x,
                                                                                    right_y))
