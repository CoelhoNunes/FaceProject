...
def face_detection(image_to_detect):
    ...
    # load the pretrained model for face detection lbpcascade is recommended for LBPH haarcascade is recommended for
    # Eigenface and Fisherface haarcascade_frontalface_default.xml download lpbcascade from
    # https://raw.githubusercontent.com/opencv/opencv/master/data/lbpcascades/lbpcascade_frontalface.xml
    face_detection_classifier = cv2.CascadeClassifier('/Users/dc/Desktop/portfoliocCodes/Face/lib/models'
...
names = []
names.append("Jay Z")
names.append("Beyonce")

# create the instance of face recognizer
face_classifier = cv2.face.FisherFaceRecognizer_create()

#########read the pretrained model ###########
face_classifier.read("/Users/dc/Desktop/portfoliocCodes/Face/lib/Images/ImagesForTest/bothjandbee.jpg")

######## prediction ##############
image_to_classify = cv2.imread("/Users/dc/Desktop/portfoliocCodes/Face/lib/Images/Test/Beyonce.jpg")
