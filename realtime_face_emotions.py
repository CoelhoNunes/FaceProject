...
# capture the video from default camera --> '/Users/dc/Desktop/portfoliocCodes/Face/lib/LiveFace.mp4'
webcam_video_stream = cv2.VideoCapture(1)  # Change file to video path if wanting a video process

# load the model and load the weights
face_exp_model = model_from_json(open("/Users/dc/Desktop/portfoliocCodes/Face/lib/DataSet"
                                      "/facial_expression_model_structure.json", "r", encoding="utf-8").read())
face_exp_model.load_weights("/Users/dc/Desktop/portfoliocCodes/Face/lib/DataSet/facial_expression_model_weights.h5")
