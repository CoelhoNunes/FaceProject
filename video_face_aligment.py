...
webcam_video_stream = cv2.VideoCapture('/Users/dc/Desktop/portfoliocCodes/Face/lib/LiveFace.mp4')
...
face_shape_predictor = dlib.shape_predictor('/Users/dc/Desktop/portfoliocCodes/Face/lib/models'
...
while True:
    ...
    for index, current_face_chip in enumerate(all_face_chips):
        # show the face chip
        cv2.imshow("Face number " + str(index + 1), current_face_chip)
