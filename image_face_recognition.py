...
original_image = cv2.imread('/Users/dc/Desktop/portfoliocCodes/Face/lib/Images/ImagesForTest/jayBeeWithPoeple.jpg')
...
known_face_names = ["Beyonce", "Jay-z"]

# load the unknown image to recognize faces in it
image_to_recognize = face_recognition.load_image_file('/Users/dc/Desktop/portfoliocCodes/Face/lib/Images'
                                                      '/ImagesForTest/jayBeeWithPoeple.jpg')
